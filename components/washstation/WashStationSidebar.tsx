 ...
 * - Settings
 * 
 * No profile display - identity verified only when needed for actions
 */
const WashStationSidebar = ({ branchName = 'Central Branch' }: SidebarProps) => {
  ...
  return (
    <aside className="hidden lg:flex w-64 bg-card border-r border-border flex-col h-screen fixed left-0 top-0 z-40">
      {/* Logo - Always navigates to Dashboard */}
      <div className="p-4 border-b border-border">
        <Link href="/washstation/dashboard" className="flex items-center gap-2">
